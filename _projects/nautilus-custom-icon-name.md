...
I'm still pretty new to python but about 30 lines of code later and I was surprised to find it worked perfectly on the first try! I could set the *custom-icon-name* metadata in the terminal and the folder icon would update automatically as I switched themes.
...
In true 80:20 fashion this last bit of polish and convenience was by far the hardest part and required another 1000 lines of code to finish. The icon selection box is built with PyGObject and I'm pretty pleased with how it turned out.
